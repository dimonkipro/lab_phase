...
if (userId) {
  ...
  if (accountLink) {
    ...
    nav.innerHTML += '<li><a href="/auth/logout">Logout</a></li>'
}
})
// header content
...
headerDiv.innerHTML = `
        ...
        <div class="header">
            <div class="navbar">
                <div class="logo">
                    <a href="/">
                        <img src="../assets/logo1.png" alt="" width="125px" /></a>
                </div>
                <nav>
                    <ul id="MenuItems">
                        <li id="search">
                        ...
                        <li><a href="/login" id="acc">Account</a></li>
                        
                    </ul>
                </nav>
                <img src="../assets/menu.png" alt="" class="menu-icon" onclick="menutoggle()" style="display: none;" />
            </div>
        </div>
...
footerDiv.innerHTML = `
    <div id="footer" class="footer">
        <div class="container">
            <div class="cards-container home footer">
                <div class="about">
                    <div class="header ">
                        <h3>Who we are</h3>
                    </div>
                    <div class="text">
                        <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Suscipit asperiores dolore aut sapiente
                                culpa soluta voluptatibus illo. Magni expedita dolorem illum </p>
                    </div>
                </div>
                ...
                <div class="contact">   
                    <div class="header ">
                     ...
                     <div class="text">
                            <i class="fa-solid fa-phone">&nbsp;+216 98 231 582</i><br>
                            <i class="fa-solid fa-location-dot">&nbsp;&nbsp;Gabes center</i><br>
                            <i class="fa-solid fa-envelope">&nbsp;&nbsp;deivengo@gmail.com</i>
                        </div>
                </div>
            </div>
            <div class="row" style="background-color: #553923; width:-webkit-fill-available; margin-top:.5rem;font-size:1.2rem; padding:.5rem;" ><p>&copy; Baboucha 2024</p></div>
        </div>
    </div>
`;
