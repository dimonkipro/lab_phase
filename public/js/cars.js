...
async function loadCars() {
  try {
    const response = await fetch("/api/cars"); // Fetch car data from the backend
    const cars = await response.json(); // Parse the JSON data

    shuffleArray(cars);
    const carList = document.getElementById("cards-container");
    carList.innerHTML = "";
